...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puede especificar mensajes de validación personalizados para los atributos usando el
    ...
    */
    ...
    | con algo más expresivo como "Dirección de correo electrónico" en lugar de "email". Esto simplemente nos ayuda a hacer que nuestro mensaje sea más expresivo.
    |
    */
